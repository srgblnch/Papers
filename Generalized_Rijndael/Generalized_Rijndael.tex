...
% draw the algorithm as a diagram TODO: redo this diagram
% \begin{figure}[b]
%  \centering
...
\matrix (k0) [matrix of math nodes,nodes = {node style ge},%
              %left delimiter  = (,right delimiter = ),
              column sep=-0.3cm,row sep=-0.5cm,
             ] at (0,0)
        {
          k_{0_{(0,0)}} & k_{0_{(0,1)}} & k_{0_{(0,2)}} & k_{0_{(0,3)}} \\
          k_{0_{(1,0)}} & k_{0_{(1,1)}} & k_{0_{(1,2)}} & k_{0_{(1,3)}} \\
          k_{0_{(2,0)}} & k_{0_{(2,1)}} & k_{0_{(2,2)}} & k_{0_{(2,3)}} \\
          k_{0_{(3,0)}} & k_{0_{(3,1)}} & k_{0_{(3,2)}} & k_{0_{(3,3)}} \\
        };
\draw [] (k0-1-1.north west) rectangle (k0-4-4.south east);

\matrix (k1) [matrix of math nodes,nodes = {node style ge},
              %left delimiter  = (,right delimiter = ),
              column sep=-0.3cm,row sep=-0.5cm,
             ] at (4.5,0)
        {
          k_{1_{(0,0)}} & k_{1_{(0,1)}} & k_{1_{(0,2)}} & k_{1_{(0,3)}} \\
          k_{1_{(1,0)}} & k_{1_{(1,1)}} & k_{1_{(1,2)}} & k_{1_{(1,3)}} \\
          k_{1_{(2,0)}} & k_{1_{(2,1)}} & k_{1_{(2,2)}} & k_{1_{(2,3)}} \\
          k_{1_{(3,0)}} & k_{1_{(3,1)}} & k_{1_{(3,2)}} & k_{1_{(3,3)}} \\
        };
\draw [] (k1-1-1.north west) rectangle (k1-4-4.south east);

% \node [] (cdots) at (7,0) {$\cdots$};
% 
% \matrix (kn) [matrix of math nodes,nodes = {node style ge},
%               %left delimiter  = (,right delimiter = ),
%               column sep=-0.3cm,row sep=-0.5cm,
%              ] at (9.5,0)
%         {
%           k_{n_{(0,0)}} & k_{n_{(0,1)}} & k_{n_{(0,2)}} & k_{n1_{(0,3)}} \\
%           k_{n_{(1,0)}} & k_{n_{(1,1)}} & k_{n_{(1,2)}} & k_{n_{(1,3)}} \\
%           k_{n_{(2,0)}} & k_{n_{(2,1)}} & k_{n_{(2,2)}} & k_{n_{(2,3)}} \\
%           k_{n_{(3,0)}} & k_{n_{(3,1)}} & k_{n_{(3,2)}} & k_{n_{(3,3)}} \\
%         };
% \draw [] (kn-1-1.north west) rectangle (kn-4-4.south east);

%boxes to get the necessary columns
\draw [blue] (k0-1-2.north west) rectangle (k0-4-2.south east);
\draw [blue] (k1-1-2.north west) rectangle (k1-4-2.south east);
\draw [red] (k1-1-3.north west) rectangle (k1-4-3.south east);

\node [diamond,draw,aspect=2] (imodc) at (3,-3) {i mod c};
\node [rectangle,draw] (rotWord) at (1,-3.5) {rotWord()};
\node [rectangle,draw] (subBytes) at (1,-4.4) {subBytes()};
\node [circle,draw] (xor) at (3,-5) {};
 \draw [-] (xor.north) -- (xor.south);
 \draw [-] (xor.west) -- (xor.east);
\node [] (eq0) at (1.7,-2.8) {=0};
\node [] (neq) at (3.3,-3.7) {$\neq0$};
\node [] (neq) at (k0-1-2.north) {$i-c$};
\node [] (neq) at (k1-1-2.north) {$i$};
\node [] (neq) at (k1-1-3.north) {$i+1$};

%arrows to set into the algorithm
\draw [|->] (k0-4-2.south) -- (-.45,-5) -- (xor.west);
\draw [|->] (k1-4-2.south) -- (4.05,-2) -- (3,-2) -- (imodc);
\draw [->] (imodc.west) -- (1,-3) -- (rotWord.north);
\draw [->] (rotWord.south) -- (subBytes.north);
\draw [->] (imodc.south) -- (xor.north);
\draw [->] (subBytes.south) -- (1,-4.8) -- (xor.north);
\draw [->] (xor.east) -- (4.95,-5) -- (k1-4-3.south);
