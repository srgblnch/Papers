...
{\bf Keywords:} Cryptography\footnote{This big keyword includes proposals over \emph{Public key}, \emph{Elliptic Curves}, \emph{Symmetric algorithms}, and \emph{stream cyphers}. Other keywords mention are the \emph{Homomorphic encryption} and \emph{secret sharing} but they are not the centre of this paper.}, Distributed Control Systems, Cryptography Engineering.
