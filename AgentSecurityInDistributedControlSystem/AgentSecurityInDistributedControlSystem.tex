...
\begin{equation}
    {\tt [tango://facility:10000/]domain/class/member-NN[-sufix]}\label{eq:tangoDeviceFullName}
\end{equation}
...
\begin{equation}
    {\tt domain/class/member-NN[-sufix]/attr}\label{eq:tangoAttrName}
\end{equation}
...
\begin{equation}
    {\tt domain/class/member-NN[-sufix][/attr]->Property}\label{eq:tangoProperty}
\end{equation}
...
\begin{equation}
    {\tt domain/class/member/attr?configure=unit}\label{eq:taurusAttrConf}
\end{equation}
