...
\begin{figure}[h]
    \centering{
         \includegraphics[width=0.7\textwidth]{imgs/identify_authenticate_authorise.png}
         \caption{Two agents authenticate each \fixme{To be improved}} \label{fig:doubleAuthentification}
    }
\end{figure}
...
\begin{figure}[h]
    \centering{
         \includegraphics[width=0.7\textwidth]{imgs/rijndael_ctr.png}
         \caption{Counter (CTR) block cipher mode.} \label{fig:rijdaelCTR}
    }
\end{figure}
