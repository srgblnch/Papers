...
\frametitle{key exchange}
    \begin{itemize}
        ...
        \item S. Blake-Wilson, N. Bolyard, V. Gupta, C. Hawk, and B. Moeller, ``\emph{Elliptic curve cryptography (ecc) cipher suites for transport layer security (tls)}'' May 2006. RFC4492
...
\begin{frame}[allowframebreaks]
        ...
        \bibliography{../bibtex/books.bib,../bibtex/standards.bib,../bibtex/ecc.bib,../bibtex/rijndael.bib}
\end{frame}
