...
\fixme{define an (?isomorfism) isogeny}
...
\todo{cryptanalysis on this matter: Given two curves isogenies between them, find a path}
\cite{FastBetweenIso}

\todo{possible side channel attacks (attacking the isogeny and to prevent attacks like trace zero points)}
